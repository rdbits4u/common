...
#define RDP_INFO_HIDEF_RAIL_SUPPORTED       0x02000000
...
#define RDP_STREAM_UNDEFINED                0x00    /* Undefined stream priority */
#define RDP_STREAM_LOW                      0x01    /* Low-priority stream */
#define RDP_STREAM_MED                      0x02    /* Medium-priority stream */
#define RDP_STREAM_HI                       0x04    /* High-priority stream */

/* type of data PDU */
#define RDP_PDUTYPE2_UPDATE                         0x02    /* Graphics Update PDU(section 2.2.9.1.1.3) */
#define RDP_PDUTYPE2_CONTROL                        0x14    /* Control PDU(section 2.2.1.15.1) */
#define RDP_PDUTYPE2_POINTER                        0x1B    /* Pointer Update PDU(section 2.2.9.1.1.4) */
#define RDP_PDUTYPE2_INPUT                          0x1C    /* Input Event PDU(section 2.2.8.1.1.3) */
#define RDP_PDUTYPE2_SYNCHRONIZE                    0x1F    /* Synchronize PDU(section 2.2.1.14.1) */
#define RDP_PDUTYPE2_REFRESH_RECT                   0x21    /* Refresh Rect PDU(section 2.2.11.2.1) */
#define RDP_PDUTYPE2_PLAY_SOUND                     0x22    /* Play Sound PDU(section 2.2.9.1.1.5.1) */
#define RDP_PDUTYPE2_SUPPRESS_OUTPUT                0x23    /* Suppress Output PDU(section 2.2.11.3.1) */
#define RDP_PDUTYPE2_SHUTDOWN_REQUEST               0x24    /* Shutdown Request PDU(section 2.2.2.1.1) */
#define RDP_PDUTYPE2_SHUTDOWN_DENIED                0x25    /* Shutdown Request Denied PDU(section 2.2.2.2.1) */
#define RDP_PDUTYPE2_SAVE_SESSION_INFO              0x26    /* Save Session Info PDU(section 2.2.10.1.1) */
#define RDP_PDUTYPE2_FONTLIST                       0x27    /* Font List PDU(section 2.2.1.18.1) */
#define RDP_PDUTYPE2_FONTMAP                        0x28    /* Font Map PDU(section 2.2.1.22.1) */
#define RDP_PDUTYPE2_SET_KEYBOARD_INDICATORS        0x29    /* Set Keyboard Indicators PDU(section 2.2.8.2.1.1) */
#define RDP_PDUTYPE2_BITMAPCACHE_PERSISTENT_LIST    0x2B    /* Persistent Key List PDU(section 2.2.1.17.1) */
#define RDP_PDUTYPE2_BITMAPCACHE_ERROR_PDU          0x2C    /* Bitmap Cache Error PDU([MS - RDPEGDI] section 2.2.2.3.1) */
#define RDP_PDUTYPE2_SET_KEYBOARD_IME_STATUS        0x2D    /* Set Keyboard IME Status PDU(section 2.2.8.2.2.1) */
#define RDP_PDUTYPE2_OFFSCRCACHE_ERROR_PDU          0x2E    /* Offscreen Bitmap Cache Error PDU([MS - RDPEGDI] section 2.2.2.3.2) */
#define RDP_PDUTYPE2_SET_ERROR_INFO_PDU             0x2F    /* Set Error Info PDU(section 2.2.5.1.1) */
#define RDP_PDUTYPE2_DRAWNINEGRID_ERROR_PDU         0x30    /* DrawNineGrid Cache Error PDU([MS - RDPEGDI] section 2.2.2.3.3) */
#define RDP_PDUTYPE2_DRAWGDIPLUS_ERROR_PDU          0x31    /* GDI + Error PDU([MS - RDPEGDI] section 2.2.2.3.4)  */
#define RDP_PDUTYPE2_ARC_STATUS_PDU                 0x32    /* Auto - Reconnect Status PDU(section 2.2.4.1.1) */
#define RDP_PDUTYPE2_STATUS_INFO_PDU                0x36    /* Status Info PDU(section 2.2.5.2) */
#define RDP_PDUTYPE2_MONITOR_LAYOUT_PDU             0x37    /* Monitor Layout PDU(section 2.2.12.1) */
#define RDP_PDUTYPE2_FRAME_ACKNOWLEDGE              0x38    /* Send frame acknowledge */
#define RDP_PDUTYPE2_KEYBOARD_LAYOUT                0x43    /* Send keyboard layout */

#define RDP_CTRLACTION_REQUEST_CONTROL      0x0001 /* Request control */
#define RDP_CTRLACTION_GRANTED_CONTROL      0x0002 /* Granted control */
#define RDP_CTRLACTION_DETACH               0x0003 /* Detach */
#define RDP_CTRLACTION_COOPERATE            0x0004 /* Cooperate */

#define RDP_CTRLACTION_REQUEST_CONTROL      0x0001
#define RDP_CTRLACTION_GRANTED_CONTROL      0x0002
#define RDP_CTRLACTION_DETACH               0x0003
#define RDP_CTRLACTION_COOPERATE            0x0004

#define CODEPAGE_UTF8                       "UTF-8"
#define CODEPAGE_UTF16_LE                   "UTF-16LE"

// fastpath update codes
#define RDP_FASTPATH_UPDATETYPE_ORDERS          0x0     // Indicates a Fast-Path Orders Update ([MS-RDPEGDI] section 2.2.2.2).
#define RDP_FASTPATH_UPDATETYPE_BITMAP          0x1     // Indicates a Fast-Path Bitmap Update (section 2.2.9.1.2.1.2).
#define RDP_FASTPATH_UPDATETYPE_PALETTE         0x2     // Indicates a Fast-Path Palette Update (section 2.2.9.1.2.1.1).
#define RDP_FASTPATH_UPDATETYPE_SYNCHRONIZE     0x3     // Indicates a Fast-Path Synchronize Update (section 2.2.9.1.2.1.3).
#define RDP_FASTPATH_UPDATETYPE_SURFCMDS        0x4     // Indicates a Fast-Path Surface Commands Update (section 2.2.9.1.2.1.10).
#define RDP_FASTPATH_UPDATETYPE_PTR_NULL        0x5     // Indicates a Fast-Path System Pointer Hidden Update (section 2.2.9.1.2.1.5).
#define RDP_FASTPATH_UPDATETYPE_PTR_DEFAULT     0x6     // Indicates a Fast-Path System Pointer Default Update (section 2.2.9.1.2.1.6).
#define RDP_FASTPATH_UPDATETYPE_PTR_POSITION    0x8     // Indicates a Fast-Path Pointer Position Update (section 2.2.9.1.2.1.4).
#define RDP_FASTPATH_UPDATETYPE_COLOR           0x9     // Indicates a Fast-Path Color Pointer Update (section 2.2.9.1.2.1.7).
#define RDP_FASTPATH_UPDATETYPE_CACHED          0xA     // Indicates a Fast-Path Cached Pointer Update (section 2.2.9.1.2.1.9).
#define RDP_FASTPATH_UPDATETYPE_POINTER         0xB     // Indicates a Fast-Path New Pointer Update (section 2.2.9.1.2.1.8).
#define RDP_FASTPATH_UPDATETYPE_LARGE_POINTER   0xC     // Indicates a Fast-Path Large Pointer Update (section 2.2.9.1.2.1.11).

// fastpath fragmentation flags
#define RDP_FASTPATH_FRAGMENT_SINGLE            0x0     // data in updateData field is not part of a sequence of fragments.
#define RDP_FASTPATH_FRAGMENT_LAST              0x1     // data in updateData field contains the last fragment in a sequence of fragments.
#define RDP_FASTPATH_FRAGMENT_FIRST             0x2     // data in updateData field contains the first fragment in a sequence of fragments.
#define RDP_FASTPATH_FRAGMENT_NEXT              0x3     // data in updateData field contains the second or subsequent fragment in a sequence of fragments.

#define RDP_FASTPATH_OUTPUT_COMPRESSION_USED    0x2     // Indicates compressionFlags field is present.
#define RDP_FASTPATH_INPUT_ACTION_FASTPATH      0x0     // Indicates the PDU is a fast-path input PDU
#define RDP_FASTPATH_INPUT_ACTION_X224          0x3     // Indicates the presence of a TPKT Header initial version byte
#define RDP_FASTPATH_INPUT_SECURE_CHECKSUM      0x1     // Indicates MAC signature for PDU was generated using the "salted MAC generation" technique
#define RDP_FASTPATH_INPUT_ENCRYPTED            0x2     // Indicates PDU contains 8-byte MAC signature after optional length2 field

// input event codes
#define RDP_FASTPATH_INPUT_EVENT_SCANCODE       0x0     // Indicates Fast-Path Keyboard Event (section 2.2.8.1.2.2.1).
#define RDP_FASTPATH_INPUT_EVENT_MOUSE          0x1     // Indicates Fast-Path Mouse Event (section 2.2.8.1.2.2.3).
#define RDP_FASTPATH_INPUT_EVENT_MOUSEX         0x2     // Indicates Fast-Path Extended Mouse Event (section 2.2.8.1.2.2.4).
#define RDP_FASTPATH_INPUT_EVENT_SYNC           0x3     // Indicates Fast-Path Synchronize Event (section 2.2.8.1.2.2.5).
#define RDP_FASTPATH_INPUT_EVENT_UNICODE        0x4     // Indicates Fast-Path Unicode Keyboard Event (section 2.2.8.1.2.2.2).
#define RDP_FASTPATH_INPUT_EVENT_QOE_TIMESTAMP  0x6     // Indicates Fast-Path Quality of Experience (QoE) Timestamp Event (section 2.2.8.1.2.2.6).

// keyboard events; see section 2.2.8.1.2.2.1 Fast-Path Keyboard Event (TS_FP_KEYBOARD_EVENT)
#define RDP_FASTPATH_INPUT_KBDFLAGS_RELEASE     0x01    // Absence of this flag indicates key-down event, while its presence indicates key-release event.
#define RDP_FASTPATH_INPUT_KBDFLAGS_EXTENDED    0x02    // Indicates keystroke message contains extended scancode. For enhanced 101-key and
...
#define RDP_FASTPATH_INPUT_KBDFLAGS_EXTENDED1   0x04    // Used to send keyboard events triggered by the PAUSE key.
...
// mouse events
#define RDP_PTRFLAGS_HWHEEL                     0x0400  // The event is a horizontal mouse wheel rotation
#define RDP_PTRFLAGS_WHEEL                      0x0200  // The event is a vertical mouse wheel rotation.
#define RDP_PTRFLAGS_WHEEL_NEGATIVE             0x0100  // The wheel rotation value (contained in the WheelRotationMask
                                                        // bit field) is negative and MUST be sign-extended before
                                                        // injection at the server.
#define RDP_WheelRotationMask                   0x01FF  // The bit field describing the number of rotation units the mouse
                                                        // wheel was rotated. The value is negative if the
                                                        // PTRFLAGS_WHEEL_NEGATIVE flag is set.
#define RDP_PTRFLAGS_MOVE                       0x0800  // Indicates that the mouse position MUST be updated to the
                                                        // location specified by the xPos and yPos fields.
#define RDP_PTRFLAGS_DOWN                       0x8000  // Indicates that a click event has occurred at the position
                                                        // specified by the xPos and yPos fields. The button flags
                                                        // indicate which button has been clicked and at least one of
                                                        // these flags MUST be set.
#define RDP_PTRFLAGS_BUTTON1                    0x1000  // Mouse button 1 (left button) was clicked or released.
                                                        // If the PTRFLAGS_DOWN flag is set, then the button was clicked,
                                                        // otherwise it was released.
#define RDP_PTRFLAGS_BUTTON2                    0x2000  // Mouse button 2 (right button) was clicked or released.
                                                        // If the PTRFLAGS_DOWN flag is set, then the button was clicked,
                                                        // otherwise it was released.
#define RDP_PTRFLAGS_BUTTON3                    0x4000  // Mouse button 3 (middle button or wheel) was clicked or
                                                        // released. If the PTRFLAGS_DOWN flag is set, then the button
                                                        // was clicked, otherwise it was released.

#define RDP_PTRXFLAGS_DOWN                      0x8000
#define RDP_PTRXFLAGS_BUTTON1                   0x0001
#define RDP_PTRXFLAGS_BUTTON2                   0x0002
...
enum TS_SHARECONTROLHEADER_PDU_TYPE
{
    SCH_PDUTYPE_DEMANDACTIVEPDU   = 0x1,
    SCH_PDUTYPE_CONFIRMACTIVEPDU  = 0x3,
    SCH_PDUTYPE_DEACTIVATEALLPDU  = 0x6,
    SCH_PDUTYPE_DATAPDU           = 0x7,
